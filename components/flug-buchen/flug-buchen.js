System.register('flug-buchen/flug-buchen', ['decorators/ng-decorators'], function (_export) {
    var Component, _classCallCheck, _createClass, FlugBuchenController;
        ...
        execute: function () {
            ...
            FlugBuchenController = (function () {
                function FlugBuchenController($http, $log, baseUrl, $router) {
                    _classCallCheck(this, _FlugBuchenController);
                ...
                var _FlugBuchenController = FlugBuchenController;
                FlugBuchenController = Component()(FlugBuchenController) || FlugBuchenController;
