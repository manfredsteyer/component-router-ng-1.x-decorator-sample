  ...
  !function(undefined) {
    ...
    (function e(t, n, r) {
      ...
      1: [function(require, module, exports) {
        ...
        "./core.dict": 32,
        "./core.global": 33,
        "./core.iter-helpers": 34,
        "./core.log": 35,
        "./core.number.iterator": 36,
        "./core.number.math": 37,
        "./core.object": 38,
        "./core.string.escape-html": 39,
        "./es5": 40,
        "./es6.array.copy-within": 41,
        "./es6.array.fill": 42,
        "./es6.array.find": 44,
        "./es6.array.find-index": 43,
        "./es6.array.from": 45,
        "./es6.array.iterator": 46,
        "./es6.array.of": 47,
        "./es6.array.species": 48,
        "./es6.function.name": 49,
        "./es6.map": 50,
        "./es6.math": 51,
        "./es6.number.constructor": 52,
        "./es6.number.statics": 53,
        "./es6.object.assign": 54,
        "./es6.object.is": 55,
        "./es6.object.set-prototype-of": 56,
        "./es6.object.statics-accept-primitives": 57,
        "./es6.object.to-string": 58,
        "./es6.promise": 59,
        "./es6.reflect": 60,
        "./es6.regexp": 61,
        "./es6.set": 62,
        "./es6.string.code-point-at": 63,
        "./es6.string.ends-with": 64,
        "./es6.string.from-code-point": 65,
        "./es6.string.includes": 66,
        "./es6.string.iterator": 67,
        "./es6.string.raw": 68,
        "./es6.string.repeat": 69,
        "./es6.string.starts-with": 70,
        "./es6.symbol": 71,
        "./es6.weak-map": 72,
        "./es6.weak-set": 73,
        "./es7.array.includes": 74,
        "./es7.object.get-own-property-descriptors": 75,
        "./es7.object.to-array": 76,
        "./es7.regexp.escape": 77,
        "./es7.string.at": 78,
        "./js.array.statics": 79,
        "./web.dom.iterable": 80,
        "./web.immediate": 81,
