  ...
  !function(undefined) {
    ...
    (function e(t, n, r) {
      ...
      1: [function(require, module, exports) {
        ...
        "./es6.map": 50,
        "./es6.math": 51,
        "./es6.number.statics": 52,
        "./es6.object.assign": 53,
        "./es6.object.is": 54,
        "./es6.object.set-prototype-of": 55,
        "./es6.object.statics-accept-primitives": 56,
        "./es6.object.to-string": 57,
        "./es6.promise": 58,
        "./es6.reflect": 59,
        "./es6.set": 60,
        "./es6.string.code-point-at": 61,
        "./es6.string.ends-with": 62,
        "./es6.string.from-code-point": 63,
        "./es6.string.includes": 64,
        "./es6.string.iterator": 65,
        "./es6.string.raw": 66,
        "./es6.string.repeat": 67,
        "./es6.string.starts-with": 68,
        "./es6.symbol": 69,
        "./es6.weak-map": 70,
        "./es6.weak-set": 71,
        "./es7.array.includes": 72,
        "./es7.object.get-own-property-descriptors": 73,
        "./es7.object.to-array": 74,
        "./es7.regexp.escape": 75,
        "./es7.string.at": 76,
        "./js.array.statics": 77,
        "./web.dom.iterable": 78,
        "./web.immediate": 79,
